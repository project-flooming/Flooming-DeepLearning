...
if __name__ == "__main__":
    ...
    # train_dataset = datasets.ImageFolder(args.dataset_path, transform=transforms_)
    ...
    for epoch in range(args.epochs):
        ...
        for batch_i, (images, _) in enumerate(dataloader):
            ...
            if args.checkpoint_interval > 0 and batches_done % args.checkpoint_interval == 0:
                ...
                torch.save(transformer.state_dict(), f"checkpoints/{style_name}_{batches_done}.pt")
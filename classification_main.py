...
def get_args_parser():
    ...
    parser.add_argument('--path', default='C:/Users/user/MY_DL/flower/dataset/flower_dataset/inputs', type=str,
                        help='Path of data')
    parser.add_argument('--img_size', default='256', type=int,
                        help='Input size of classification model')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('MobileNetV3 training', parents=[get_args_parser()])
